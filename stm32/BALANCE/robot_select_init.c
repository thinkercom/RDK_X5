...
void Robot_Select(void)
{
  ...
  if(Car_Mode>5)Car_Mode=5;
	...
	switch(Car_Mode)
		...
		case Mec_Car:
			#if C300_MEC
			Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     GEAR_50F, Hall_11, Mecanum_97);
			#elif C400_MEC
			Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     GEAR_30F, Photoelectric_448, Mecanum_97);
            #elif C500_MEC
			Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     GEAR_50F, Hall_11, Mecanum_97);
			#elif C600_MEC
			Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     GEAR_90F, Hall_16, Mecanum_97);
			#elif C800_MEC
			Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          0,                     GEAR_50F, Hall_11, Mecanum_127);
            #else
			Robot_Init(MEC_wheelspacing,		 MEC_axlespacing,		   0,					  GEAR_50F, Hall_11, Mecanum_97);			
			#endif
		    break; //麦克纳姆轮小车
		case Omni_Car:      Robot_Init(0,                        0,                        Omni_Turn_Radiaus_109, GEAR_30F, Hall_11, FullDirecion_60);       break; //全向轮小车
	//	case Omni_4WHEEL:   Robot_Init(0,                        0,                        Omni_Turn_Radiaus_109, HALL_30F, Hall_11, FullDirecion_60);       break; //全向轮小车
		case Akm_Car:       Robot_Init(Akm_wheelspacing,         Akm_axlespacing,          0,                     GEAR_30F, Hall_11, Black_WheelDiameter);   break; //阿克曼小车
		case Diff_Car:      Robot_Init(Diff_wheelSpacing,        0,                        0,                     GEAR_30F, Hall_11, Black_WheelDiameter);   break; //两轮差速小车
		case FourWheel_Car: 
            #if T500
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_75F, Hall_11, Black_WheelDiameter);   break; //四驱车 
			#elif TS500
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_50F, Photoelectric_448, Black_WheelDiameter);   break; //四驱车 
			#elif C400_4WD
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_50F, Hall_11, Black_WheelDiameter);   break; //四驱车 
			#elif C500_4WD
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_56F, Photoelectric_400, Black_WheelDiameter);   break; //四驱车 
			#elif C1000_4WD
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_28F, Hall_13, Black_WheelDiameter);   break; //四驱车 
			#elif C100PRO_4WD
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_30F, Photoelectric_448, Black_WheelDiameter);   break; //四驱车 
            #elif TS900 || T900
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_30F, Hall_11, Black_WheelDiameter);   break; //四驱车 
            #else
			Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0,                     GEAR_50F, Hall_11, Black_WheelDiameter);   break; //四驱车 
			#endif
		case Tank_Car:  
	        ...
	        #if TR300
			Robot_Init(Tank_wheelSpacing,		 0, 					   0,					  GEAR_30F, Hall_11, Tank_WheelDiameter);	break; //履带车
            #elif T10
			Robot_Init(Tank_wheelSpacing,		 0, 					   0,					  GEAR_75F, Hall_11, Tank_WheelDiameter);	break; //履带车
			#elif T200
			Robot_Init(Tank_wheelSpacing,		 0, 					   0,					  GEAR_75F, Hall_11, Tank_WheelDiameter);	break; //履带车
			#elif WT600
			Robot_Init(Tank_wheelSpacing,		 0, 					   0,					  GEAR_28F, Hall_13, Tank_WheelDiameter);	break; //履带车
			#elif TS100P
			Robot_Init(Tank_wheelSpacing,		 0, 					   0,					  GEAR_30F, Photoelectric_448, Tank_WheelDiameter);	break; //履带车
			#elif TS800
			Robot_Init(Tank_wheelSpacing,        0,                        0,                     GEAR_30F, Hall_11, Tank_WheelDiameter);  break; //四驱车 
			#else
            Robot_Init(Tank_wheelSpacing,		 0, 					   0,					  GEAR_75F, Hall_11, Tank_WheelDiameter);	break; //履带车
			#endif
	}
